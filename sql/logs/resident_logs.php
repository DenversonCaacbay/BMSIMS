  ...
  <script>
        $(document).ready(function () {
            ...
            $('.deletebtn7').on('click', function () {
                ...
                $('#firstname1').val(data[4]);
                $('#middlename1').val(data[5]);    
                $('#lastname1').val(data[6]);
                $('#gender1').val(data[7]);
                $('#place_of_birth1').val(data[8]);
                $('#bdate1').val(data[9]);
                $('#civil_status1').val(data[10]);
                $('#address1').val(data[11]);
                $('#purok1').val(data[12]);
                $('#email1').val(data[13]);
                $('#phone1').val(data[14]);
                $('#password1').val(data[15]);
