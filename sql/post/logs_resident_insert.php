...
<?php 
    ...
    if($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        if($countProd > 0){
            ...
            // insert product
            $sql = 'INSERT INTO tbl_resident(username, firstname, middlename, lastname, gender, place_of_birth, bdate, civil_status,address, purok, email,phone, password) VALUES (:username ,:firstname, :middlename, :lastname, :gender, :place_of_birth, :bdate, :civil_status,:address, :purok, :email, :phone, :password)';
            ...
            $newProd2['password'] = $_POST['password'];;
            ...
            swal({
                position: "top-end",
                type: "success",
                title: "Retrieve Record Successfully",
