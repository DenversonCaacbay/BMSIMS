...
<?php 
    ...
    if($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        // $reference_no = $_POST['reference_no'];
         ...
         $searchDate = "SELECT * FROM tbl_request WHERE username='".$username."' AND request_type='Business Permit Renewal' AND request_status = 'Please Wait'";
        ...
        //  $countProd2 = $statement2->rowCount();
         ...
         if($countProd1 > 0){
            ...
            if($_POST['payment_method'] == 'Gcash4')
            {
