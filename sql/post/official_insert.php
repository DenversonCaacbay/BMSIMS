...
<?php 
    ...
    if($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        if($countProd > 0){
            ...
            // insert product
            $sql = 'INSERT INTO tbl_officials(image, position, firstname, middlename, lastname) VALUES ("'.$imgData.'" ,:position ,:firstname, :middlename, :lastname)';
