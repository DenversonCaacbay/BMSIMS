...
<?php 
    ...
    if($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        $reference_no = $_POST['reference_no'];
         ...
         $searchDate = "SELECT * FROM tbl_id WHERE email='".$email."' AND request_status = 'Pending'";
         $searchRef = "SELECT * FROM tbl_id WHERE reference_no = '".$reference_no."'";
        ...
        //  $countProd2 = $statement2->rowCount();
         ...
         if($countProd1 > 0){
            ...
            $sql = 'INSERT INTO tbl_id(tracking_id,req_date, fullname, request_type, notify, address, contact, get_date, payment_method,reference_no,amount,date_paid, payment_status, request_status,email) 
            VALUES (:tracking_id,:req_date ,:fullname, :request_type, :notify, :address, :contact, :get_date, :payment_method,:reference_no,:amount,:date_paid, :payment_status, :request_status,:email)';
            ...
            if($_POST['payment_method'] == 'Gcash1')
            {
