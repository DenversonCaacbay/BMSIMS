...
$query = "
SELECT * FROM tbl_request WHERE request_type='Barangay ID' AND payment_method='Gcash' AND request_status='Pending'";
...
if($total_data > 0)
{
  foreach($result as $row)
  {
    ...
    <tr>
      ...
      <td class="text-center" hidden>'.'<button type="button" style="width:100%;" class="btn editbtn1"><i class="fas fa-user-edit" style="font-size:20px;"></i></button>'.'</td>
