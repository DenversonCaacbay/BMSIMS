...
<?php 
    ...
    $sql = "UPDATE tbl_request
        SET amount= :amount, payment_status= :payment_status, request_status = :request_status WHERE req_id = :req_id";
        ...
        echo'
                ...
                swal({
                    ...
                    timer: 1500
                     ...
                     window.location.href="../../../../staff/business_permit_renewal/business_permit_renewal_gcash/get_record.php";
                })
                });
