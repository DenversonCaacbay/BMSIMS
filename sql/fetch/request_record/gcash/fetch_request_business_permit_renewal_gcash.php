      ...
      <script>
        $(document).ready(function () {
            ...
            $('.deletebtn1').on('click', function () {
                ...
                $('#req_id3').val(data[0]);
                $('#tracking_id3').val(data[1]);
                $('#req_date3').val(data[2]);
                $('#fullname3').val(data[3]);    
                $('#request_type3').val(data[4]);
                $('#purpose3').val(data[5]);
                $('#date_open3').val(data[6]);
                $('#date_close3').val(data[7]);
                $('#get_date3').val(data[8]);
                $('#payment_method3').val(data[9]);
                $('#reference_no3').val(data[10]);
                $('#amount3').val(data[11]);
                $('#date_paid3').val(data[12]);
                $('#payment_status3').val(data[13]);
                $('#request_status3').val(data[14]);
                $('#username3').val(data[15]);
...
$query = "
SELECT * FROM tbl_request WHERE request_type='Business Permit Renewal' AND payment_method='Gcash' AND request_status='Please Wait'
";
