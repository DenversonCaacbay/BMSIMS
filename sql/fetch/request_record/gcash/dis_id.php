...
<?php 
    ...
    $data['date_paid'] = $_POST['date_paid'];
    // $data['date_paid'] = $_POST['date_paid'];
        ...
        echo'
                ...
                swal({
                    ...
                    timer: 1500
                     ...
                     window.location.href="../../../../staff/barangay_clearance/barangay_clearance_gcash/disapproved.php";
                })
                });
...
return;
        ...
        echo "<script>
        alert('Update Failed!');
        window.location.href='../../../staff/barangay_clearance_gcash.php';
        </script>";
    }
