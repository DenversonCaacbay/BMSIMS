...
$query = "
SELECT * FROM tbl_request WHERE request_type='Barangay Clearance' AND payment_method='Pick Up' AND request_status='Disapproved'
";
...
<table class="table table-hover sticky">
  ...
  <tr>
      ...
      <th class="text-center">Date Disapprove </th>
      ...
      <th class="text-center" hidden>Receipt</th>
    </tr>
  </thead>
';
if($total_data > 0)
  ...
  foreach($result as $row)
  {
    ...
    <tbody id="myTable">
      <tr>
        ...
        <td class="text-center">'.date("F d, Y - l", strtotime($row["date_paid"])).'</td>
