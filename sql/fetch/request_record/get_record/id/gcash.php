...
$query = "
SELECT * FROM tbl_request WHERE request_type='Barangay ID' AND payment_method='Gcash' AND request_status='Get Record'
";
  ...
  foreach($result as $row)
  {
    ...
    <tbody id="myTable">
      <tr>
        ...
        <td class="text-center" class="text-center" class="text-center">'."<a href='../../generate_id.php?pdf=1&id=".$row['req_id']."' target='_blank'><i class='fas fa-file-invoice'></i></a>".'</td>
        <td class="text-center">'.'<button type="button" style="width:100%;" class="btn btn-custom editbtn">Mark as Done</button>'.'</td>
      </tr>
    </tbody>
