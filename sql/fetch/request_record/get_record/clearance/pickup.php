...
$query = "
SELECT * FROM tbl_request WHERE request_type='Barangay Clearance' AND payment_method='Pick Up' AND request_status='Get Record'
";
  ...
  foreach($result as $row)
  {
    ...
    <tbody id="myTable">
      <tr>
        ...
        <td class="text-center">'."<a href='../../generate_clearance.php?pdf=1&id=".$row['req_id']."' target='_blank'><i class='fas fa-file-invoice'></i></a>".'</td>
