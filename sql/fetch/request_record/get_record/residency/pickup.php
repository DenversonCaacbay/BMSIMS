...
$query = "
SELECT * FROM tbl_request WHERE request_type='Residency' AND payment_method='Pick Up' AND request_status='Get Record'
";
  ...
  foreach($result as $row)
  {
    ...
    <tbody id="myTable">
      <tr>
        ...
        <td class="text-center">'."<a href='../../generate_residency.php?pdf=1&id=".$row['req_id']."' target='_blank'><i class='fas fa-file-download'></i></a>".'</td>
