...
$query = "
SELECT * FROM tbl_request WHERE request_type='Business Permit' AND payment_method='Pick Up' AND request_status='Done'
";
  ...
  foreach($result as $row)
  {
    ...
    <tbody id="myTable">
      <tr>
        ...
        <td class="text-center">'."<a href='../../print_invoice.php?pdf=1&id=".$row['req_id']."' target='_blank'>PDF</a>".'</td>
      </tr>
    </tbody>
    ';
  }
