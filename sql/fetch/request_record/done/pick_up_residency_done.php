...
$query = "
SELECT * FROM tbl_request WHERE request_type='Residency' AND payment_method='Pick Up' AND request_status='Done'
";
  ...
  foreach($result as $row)
  {
    ...
    <tbody id="myTable">
      <tr>
        ...
        <td class="text-center">'."<a href='../../print_invoice.php?pdf=1&id=".$row['req_id']."' target='_blank'><i class='fas fa-file-invoice'></a>".'</td>
      </tr>
    </tbody>
    ';
  }
