...
$query = "
SELECT * FROM tbl_request WHERE request_type='Business Permit' AND payment_method='Pick Up' AND request_status='Pending'
";
  ...
  foreach($result as $row)
  {
    ...
    <tbody id="myTable">
      <tr>
        ...
        <td class="text-center">'.$row["date_open"].'</td>
        ...
        <td class="text-center">'.'<button type="button" style="width:auto;margin-right:5px" class="btn editbtn btn-success">Get Record</button><button type="button" style="width:auto;" class="btn disbtn btn-danger">Disapproved</button>'.'</td>
      </tr>
    </tbody>
