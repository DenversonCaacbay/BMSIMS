...
// else if($_POST['query'] == 'Get A Job'){
//   $query = "SELECT * FROM tbl_request WHERE request_type='Barangay Clearance' 
//     AND purpose='Getting A Job' AND request_status='Please Wait'";
