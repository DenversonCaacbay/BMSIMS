...
$filename = 'Paid Records as of-' .date('Y-m-d').'.csv';
...
$array = array("Full Name","Date Request","Amount","Date Paid","Payment Status");
fputcsv($file,$array);
...
while($row = mysqli_fetch_array($result))
{
    ...
    $array = array($fullname,$req_date,$amount,$date_paid,$payment_status);
    fputcsv($file,$array);
}
fclose($file);
