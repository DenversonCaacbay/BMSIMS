...
$filename = 'Business Permit Records as of-' .date('Y-m-d').'.csv';

$sql = "SELECT *FROM tbl_request WHERE request_type='Business Permit'";
$result = mysqli_query($conn,$sql);

$array = array();

$file =fopen($filename,'w');
$array = array("Fullname","Date Open","Payment Method","Payment Status","Request Status");
fputcsv($file,$array);
...
while($row = mysqli_fetch_array($result))
{
    ...
    $array = array($fullname,$date_open,$payment_method,$payment_status,$request_status);
    fputcsv($file,$array);
}
fclose($file);
