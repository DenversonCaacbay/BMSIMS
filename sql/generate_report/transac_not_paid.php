...
$filename = 'Barangay Program Records as of-' .date('Y-m-d').'.csv';
...
$array = array("Program Id","Event Title","Event Date Time","Event Place","Event Description");
fputcsv($file,$array);
...
while($row = mysqli_fetch_array($result))
{
    ...
    $array = array($program_id,$event_title,$event_datetime,$place,$description);
    fputcsv($file,$array);
}
fclose($file);
