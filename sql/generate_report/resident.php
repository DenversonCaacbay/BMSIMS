...
$filename = 'Barangay Residents Records as of-' .date('Y-m-d').'.csv';
...
$array = array("Account Id","Firstname","Middlename","Lastname","Gender","Place of Birth","Birthdate","Civil Status","Email","Purok","Contact No");
fputcsv($file,$array);
...
while($row = mysqli_fetch_array($result))
{
    ...
    $array = array($acc_id, $firstname, $middlename, $lastname, $gender, $place_of_birth, $bdate, $civil_status, $email, $purok, $phone );
    fputcsv($file,$array);
}
fclose($file);
