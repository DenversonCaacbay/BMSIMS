...
require_once '../../fpdf/fpdf.php';
 ...
 $result ="SELECT * FROM tbl_programs ORDER BY program_id";
...
$pdf->Cell(120);
$pdf->Cell(50, 10, 'Barangay Programs', 1, 0, 'C');
$pdf->Ln(20);

$pdf->Cell(10,10,'ID',1);
$pdf->Cell(40,10,'Event Title',1);
$pdf->Cell(35,10,'Date',1);
$pdf->Cell(35,10,"Place",1);
$pdf->Cell(155,10,'Description',1);
	$pdf->Ln();
 ...
 while($row = $sql->fetch_object())
 {
    ...
    $pdf->Cell(10,10,$program_id,1);
    $pdf->Cell(40,10,$event_title,1,);
    $pdf->Cell(35,10,$event_datetime,1);
    $pdf->Cell(35,10,$place,1);
    $pdf->Cell(155,10,$description,1);
    $pdf->Ln();
