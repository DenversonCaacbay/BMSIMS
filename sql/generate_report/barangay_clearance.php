...
$filename = 'Barangay Clearance Records as of-' .date('Y-m-d').'.csv';

$sql = "SELECT *FROM tbl_request WHERE request_type='Barangay Clearance'";
$result = mysqli_query($conn,$sql);

$array = array();

$file =fopen($filename,'w');
$array = array("Fullname","Purpose","Payment Method","Payment Status","Request Status");
fputcsv($file,$array);
...
while($row = mysqli_fetch_array($result))
{
    ...
    $array = array($fullname,$purpose,$payment_method,$payment_status,$request_status);
    fputcsv($file,$array);
}
fclose($file);
