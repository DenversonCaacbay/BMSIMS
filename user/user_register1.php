...
<html lang="en">
  <head>
    ...
    />
    <title>BMSIMS | Registration Form</title>
  </head>
  <body class="bg-light">
    <div class="container mt-3">
      ...
      <input type="hidden" name="access" class="form-control" hidden>
      <div class="">
        ...
        <div class="mt-3">
          ...
          <input type="text" name="fname" class="form-control" id="position" />
        </div>
        <div class="mt-3">
          <label for="position">Middle Name</label>
          <input type="text" name="mname" class="form-control" id="position" />
        </div>
        <div class="mt-3">
          <label for="position">Last Name</label>
          <input type="text" name="lname" class="form-control" id="position" />
        </div>
      ...
      <div class="form-step">
        ...
        <div class="mt-3 mb-3">
          ...
          <select style="padding:13px;" class="form-control form-select" name="status" id="inputGroupSelect01">
            <option selected disabled> </option>
      ...
      <div class="form-step">
        <div class="mt-3">
          <label for="dob">House Number / Street</label>
      ...
      <div class="form-step">
        <div class="mt-3">
          ...
          <input type="file" class="form-control" name="validation"/>
        </div>
        <div class="container mt-3 mb-3 sample">
          <div class="row">
            <div class="col-6"><a href="#" class="btn btn-prev">Previous</a></div>
