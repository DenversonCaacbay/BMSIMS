...
if(isset($_GET["pdf"]) && isset($_GET["id"]))
{
 ...
 $statement = $connect->prepare("
  SELECT * FROM tbl_invoice   WHERE invoice_id = :invoice_id
  LIMIT 1
 ");
 $statement->execute(
  array(
...
<body>
  ...
  <table width="100%">
    <tr>
        <td><strong style="color: #27329b">Invoice ID:</strong> '.$row["invoice_id"].'</td>
