...
<head>
    ...
    <title>BMSIMS | Not Yet Approve</title>
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <button type="button" class="btn btn-custom" data-dismiss="modal" aria-label="Close">X</button>
      </div>
...
<!--End of Modal Add-->
      ...
      <div class="modal fade" id="grantmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            <div class="modal-header">
              <h3 style="color: #27329b; font-weight:600; margin: 10px;"id="exampleModalLabel"></h3>
              <button type="button" style="background: #27329b; color:white;" class="btn" data-dismiss="modal" aria-label="Close">
                  X
              </button>
            </div>
            <form action="../sql/account_admin/resident_grant_access.php" method="POST">
              <div class="modal-body">
                <div class="row">
                  <h5>Do you want to Approve this account?</h5>
                  <input type="text" name="res_id" id="acc_id6" hidden>
                  <input type="text" name="access" value="Approved" class="form-control" hidden>
                  <input type="text" name="created_at" value="<?php echo date("Y-m-d"); ?>" class="form-control" hidden>
                  <input type="text" name="acc_id" value="<?php echo $_SESSION['user_id'] ?>" hidden>
                  <input type="text" name="staff" value="<?php echo $_SESSION['fullname'] ?>" hidden>
                  <input type="text" name="fname" id="firstname6" class="form-control" hidden>
                  <input type="text" name="mname" id="middlename6" class="form-control" hidden>
                  <input type="text" name="lname" id="lastname6" class="form-control" hidden>
                  <input type="text" name="gender" id="gender6" class="form-control" hidden>
                  <input type="text" name="pob" id="place_of_birth6" class="form-control" hidden>
                  <input type="text" name="bdate" id="bdate6" class="form-control" hidden>
                  <input type="text" name="status" id="civil_status6" class="form-control" hidden>
                  <input type="text" name="street" id="address6" class="form-control" hidden>
                  <input type="text" name="purok" id="purok6" class="form-control" hidden>
                  <input type="text" name="email" id="email6" class="form-control" hidden>
                  <input type="text" name="phone" id="phone6" class="form-control" hidden>
                  <input type="text" name="date_config" value="<?php echo date("Y-m-d"); ?>" hidden>
                  <input type="text" name="status" class="form-control" placeholder="" value="Approved" hidden>
                </div>
              </div>
              <div class="modal-footer">
    ...
    <!-- End Of Grant Access -->
        ...
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            ...
            <form action="../sql/account_admin/resident_dis_access.php" method="POST">
              <div class="modal-body">
                <div class="row">
                  <h5>Do you want to Disapproved this account?</h5>
                  <input type="text" name="res_id" id="acc_id7" hidden>
                  <input type="text" name="access" value="Disapproved" class="form-control" hidden>
                  <input type="text" name="created_at" value="<?php echo date("Y-m-d"); ?>" class="form-control" hidden>
                  <input type="text" name="acc_id" value="<?php echo $_SESSION['user_id'] ?>" hidden>
                  <input type="text" name="staff" value="<?php echo $_SESSION['fullname'] ?>" hidden>
                  <input type="text" name="fname" id="firstname7" class="form-control" hidden>
                  <input type="text" name="mname" id="middlename7" class="form-control" hidden>
                  <input type="text" name="lname" id="lastname7" class="form-control" hidden>
                  <input type="text" name="gender" id="gender7" class="form-control" hidden>
                  <input type="text" name="pob" id="place_of_birth7" class="form-control" hidden>
                  <input type="text" name="bdate" id="bdate7" class="form-control" hidden>
                  <input type="text" name="status" id="civil_status7" class="form-control" hidden>
                  <input type="text" name="street" id="address7" class="form-control" hidden>
                  <input type="text" name="purok" id="purok7" class="form-control" hidden>
                  <input type="text" name="email" id="email7" class="form-control" hidden>
                  <input type="text" name="phone" id="phone7" class="form-control" hidden>
                  <input type="text" name="date_config" value="<?php echo date("Y-m-d"); ?>" hidden>
                  <input type="text" name="status" class="form-control" placeholder="" value="Disapproved" hidden>
                </div>
              </div>
              <div class="modal-footer">
                <button type="button" style="background: #27329b; color:white;" class="btn successbtn" data-dismiss="modal" aria-label="Close">Cancel</button>
      ...
      <div class="card-body">
        <div class="container">
          <div class="row">
            ...
            <div class="col-lg-3" >
            <!-- <a hidden href="../sql/generate_report/resident.php"  class="btn btn-custom"  id="btnExport" value="Export" target="_blank">Generate PDF</a> -->
          ...
          <nav style="--bs-breadcrumb-divider: '|';" aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item" aria-current="page"><a class="link-active b-crumb" href="pending_accounts.php">Pending Accounts</a></li>
                <li class="breadcrumb-item"><a class="b-crumb" href="approved_accounts.php">Approved Accounts</a></li>
...
<script>
  $(document).ready(function(){
    ...
    {
      $.ajax({
        url:"../sql/account_admin/pending_accounts.php",
        method:"POST",
