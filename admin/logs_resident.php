...
<head>
    ...
    <title>Admin | Resident Logs</title>
    <link
      rel="stylesheet"
                ...
                <div class="row">
                    ...
                    <div class="col-lg-5">
                      <div class="tab1">
                          ...
                          <a class="btn tablinks btn-custom btn-active" href="logs_resident.php">Resident</a>
                          <a class="btn tablinks btn-custom " href="logs_transaction.php">Transaction</a>
                        </div>
                    </div>
...
<script>
  $(document).ready(function(){
    ...
    {
      $.ajax({
        url:"../sql/logs/resident_logs.php",
        method:"POST",
