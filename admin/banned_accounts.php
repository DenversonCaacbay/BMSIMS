...
<head>
    ...
    <title>BMSIMS | Banned Accounts</title>
                ...
                <div class="modal-body">
                  ...
                  <div class="row">
                    <div class="col-md-12 form-group" hidden>
                      ...
                      <input type="text" name="access" value="Approved" class="form-control">
                    </div>
                      ...
                      <input type="text" name="fname" id="fname6" class="form-control" hidden>
                    ...
                    <div class="modal-footer">
                        <button type="submit" name="updatedata" style="background: #27329b; color:white;width:100%" class="btn successbtn">Grant</button>
                    </div>
                </form>
        ...
        <div class="container">
          ...
          <nav style="--bs-breadcrumb-divider: '|';" aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a class="link-active b-crumb" href="banned_accounts.php">Banned Accounts</a></li>
            </ol>
        </nav>
        </div>
        <div class="container">
...
<script>
  $(document).ready(function(){
    ...
    {
      $.ajax({
        url:"../sql/account_admin/fetch_residents_banned_accounts.php",
        method:"POST",
