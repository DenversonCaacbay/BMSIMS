...
<div class="vertical-nav" id="sidebar">
  ...
  <p class="text-light font-weight-bold">Account Manager</p>
    ...
    <li class="nav-item">
      <a href="resident_accounts.php" class="nav-link hover-dark text-light">
      <i class="fas fa-user  mr-3 text-light fa-fw"></i>
                Residents Account
            </a>
    </li>
        ...
        <div class="card-body">
            <div class="container">
                <div class="row">
                    ...
                    Resident Account <i class="fas fa-user  mr-3 fa-fw"></i>
                    </div>
                    <div class="col-lg-3">
    ...
    <div class="container">
          <div class="card2">
            <div class="card-body">
              ...
              <div class="table-responsive mt-2" style="height:480px" id="dynamic_content">
                <!--Sample-->
...
<script>
  $(document).ready(function(){
    ...
    {
      $.ajax({
        url:"../sql/account_admin/fetch_residents_accounts.php",
        method:"POST",
