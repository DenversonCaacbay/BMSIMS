                ...
                <div class="row">
                    ...
                    <div class="col-lg-4"> 
                      <div class="tab1">
                        ...
                        <a class="btn tablinks btn-custom" href="payment_history.php">All</a>
                        <a class="btn tablinks btn-custom btn-active" href="payment_history_pickup.php">Pick Up</a>
...
<script>
  $(document).ready(function(){
    ...
    {
      $.ajax({
        url:"../sql/logs/transaction_pickup.php",
        method:"POST",
