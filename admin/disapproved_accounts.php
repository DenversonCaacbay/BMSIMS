...
<head>
    ...
    <title>BMSIMS | Disapprove Accounts</title>
...
<div class="modal fade" id="editmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                ...
                <div class="modal-body">
                  ...
                  <div class="row">
                    <div class="mb-3 password-container">
                      ...
                      <input type="text" name="firstname" id="firstname" class="form-control" hidden>
    ...
    <!-- Grant Access -->
<div class="modal fade" id="grantmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                <h3 style="color: #27329b; font-weight:600; margin: 10px;"id="exampleModalLabel">Grant Access...</h3>
                    <button type="button" style="background: #27329b; color:white;" class="btn" data-dismiss="modal" aria-label="Close">
                        X
                    </button>
                </div>
                ...
                <div class="modal-body">
                  <input type="hidden" name="acc_id" id="acc_id6" required>
                  <div class="row">
                    <div class="col-md-12 form-group">
                      <label>Grant Access</label>
                      <select style="padding:7px;" class="form-control form-select" name="admin_power" id="admin_power6">
                        <option selected> </option>
                      ...
                      <input type="text" name="acc_id" value="<?php echo $_SESSION['user_id'] ?>" hidden>
                      <input type="text" name="staff" value="<?php echo $_SESSION['fullname'] ?>" hidden>
                      <input type="text" name="username" id="username6" class="form-control" hidden>
                      <input type="text" name="firstname" id="firstname6" class="form-control" hidden>
                      <input type="text" name="middlename" id="middlename6" class="form-control" hidden>
                      <input type="text" name="lastname" id="lastname6" class="form-control" hidden>
                      <input type="text" name="gender" id="gender6" class="form-control" hidden>
                      <input type="text" name="place_of_birth" id="place_of_birth6" class="form-control" hidden>
                      <input type="text" name="bdate" id="bdate6" class="form-control" hidden>
                      <input type="text" name="civil_status" id="civil_status6" class="form-control" hidden>
                      <input type="text" name="address" id="address6" class="form-control" hidden>
                      ...
                      <input type="text" name="password" id="password6" class="form-control" hidden>
                      <input type="text" name="date_config" value="<?php echo date("Y-m-d"); ?>" hidden>
                      <input type="text" name="status" class="form-control" placeholder="" value="Update" hidden>
                  </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-12 form-group">
                        <input type="text" name="admin_power" value="Banned" class="form-control" hidden>
                      </select>
                    </div>
                      ...
                      <input type="text" name="staff" value="<?php echo $_SESSION['fullname'] ?>" hidden>
                      <input type="text" name="username" id="username6" class="form-control" hidden>
                      <input type="text" name="firstname" id="firstname9" class="form-control" hidden>
                      <input type="text" name="middlename" id="middlename9" class="form-control" hidden >
                      <input type="text" name="lastname" id="lastname9" class="form-control" hidden>
                      <input type="text" name="gender" id="gender6" class="form-control" hidden>
                      <input type="text" name="place_of_birth" id="place_of_birth6" class="form-control" hidden>
                      <input type="text" name="bdate" id="bdate6" class="form-control" hidden>
                      <input type="text" name="civil_status" id="civil_status6" class="form-control" hidden>
        ...
        <div class="container">
          ...
          <nav style="--bs-breadcrumb-divider: '|';" aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a class="link-active b-crumb" href="disapproved_accounts.php">Disapproved Accounts</a></li>
...
<script>
  $(document).ready(function(){
    ...
    {
      $.ajax({
        url:"../sql/account_admin/fetch_residents_not_approve.php",
        method:"POST",
