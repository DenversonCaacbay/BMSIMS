...
<div class="modal fade" id="editmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="../../sql/fetch/request_record/gcash/request_gcash_residency_update.php" method="POST">
...
<div class="page-content p-0" id="content">
  ...
  <div class="separator"></div>
        ...
        <nav style="margin-left:15px;--bs-breadcrumb-divider: '|';" aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item" aria-current="page"><a href="residency_gcash.php" class="link-active">All Request</a></li>
                <!-- <li class="breadcrumb-item"><a href="residency_gcash/processed.php">Processed</a></li> -->
                <li class="breadcrumb-item"><a href="residency_gcash/get_record.php">Get Record</a></li>
                <li class="breadcrumb-item"><a href="residency_gcash/done.php">Done</a></li>
            </ol>
        </nav>
            <div class="card-req">
                <div class="card-body">
                  <div class="row">
                    <div class="col-12">
                      <div class="row">
                        ...
                        <div class="col-3">
                        <a href="residency_gcash.php" class="btn btn-custom" style="width: 50px; float:right;padding:12px"><i class="fas fa-redo-alt" style="color:white;font-size:20px"></i></a>
...
<script>
  $(document).ready(function(){
    ...
    {
      $.ajax({
        url:"../../sql/fetch/request_record/gcash/fetch_request_residency_gcash.php",
        method:"POST",
