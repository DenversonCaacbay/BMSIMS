...
<div class="modal fade" id="editmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="../../../sql/fetch/request_record/processed/residency/update_gcash.php" method="POST">
                <div class="modal-body">
                    ...
                    <input type="text" name="get_date" id="get_date" class="form-control" placeholder="" >
...
<div class="page-content p-0" id="content">
  ...
  <div class="separator"></div>
            ...
            <div class="card-body">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-sm-2">
                          <div class="tab">
                            <a href="../residency_pickup.php" class="btn btn-custom tablinks">Pick Up</a>
                            <a href="../residency_gcash.php" class="btn btn-custom btn-active  tablinks">Gcash</a>
                        </div>
                        </div>
                    </div>
                </div>
        ...
        <nav style="margin-left:15px;--bs-breadcrumb-divider: '|';" aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item" aria-current="page"><a href="../residency_gcash.php">All Request</a></li>
                  ...
                  <div class="row">
                    <div class="col-12">
                      <div class="row">
                        ...
                        <div class="col-3">
                        <a href="processed.php" class="btn btn-custom" style="width: 50px; float:right;padding:12px"><i class="fas fa-redo-alt" style="color:white;font-size:20px"></i></a>
...
<script>
  $(document).ready(function(){
    ...
    {
      $.ajax({
        url:"../../../sql/fetch/request_record/processed/residency/gcash.php",
        method:"POST",
