...
<div class="modal fade" id="editmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="../../sql/fetch/request_record/pickup/request_residency_update.php" method="POST">
                ...
                <h5>Proceed this request from getting record?</h5>
                    ...
                    <div class="col-md-12 form-group mb-3" hidden>
                            ...
                            <div class="col-sm-12 form-group" style="margin-top: 10px" hidden>
                                ...
                                <input type="text" name="payment_status" value="Paid" class="form-control" readonly>
                            </div>
                            <div class="col-sm-12 form-group" style="margin-top: 10px" hidden>
                              <label>Request Status</label>
                              <input type="text" name="request_status" value="Get Record" class="form-control" readonly>
                            </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="../../sql/fetch/request_record/pickup/dis_residency.php" method="POST">
                <div class="modal-body">
...
<div class="page-content p-0" id="content">
  ...
  <div class="separator"></div>
        ...
        <nav style="margin-left:15px;--bs-breadcrumb-divider: '|';" aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item" aria-current="page"><a href="residency_pickup.php" class="link-active">Pending Request</a></li>
                <!-- <li class="breadcrumb-item"><a href="residency_pickup/processed.php">Processed</a></li> -->
                <li class="breadcrumb-item"><a href="residency_pickup/get_record.php">Get Record</a></li>
                <li class="breadcrumb-item"><a href="residency_pickup/done.php">Done</a></li>
                <li class="breadcrumb-item"><a href="residency_pickup/disapproved.php">Disapproved</a></li>
            </ol>
        </nav>
            <div class="card-req">
                <div class="card-body">
                  <div class="row">
                    <div class="col-12">
                      <div class="row">
                        ...
                        <div class="col-3">
                        <a href="residency_pickup.php" class="btn btn-custom" style="width: 50px; float:right;padding:12px"><i class="fas fa-redo-alt" style="color:white;font-size:20px"></i></a>
...
<script>
  $(document).ready(function(){
    ...
    {
      $.ajax({
        url:"../../sql/fetch/request_record/pickup/fetch_request_residency_pick_up.php",
        method:"POST",
