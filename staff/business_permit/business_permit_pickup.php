...
<head>
    ...
    <title>BMSIMS | Business Permit</title>
...
<div class="modal fade" id="editmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="../../sql/fetch/request_record/pickup/request_permit_update.php" method="POST">
                ...
                <h5>Proceed this request from getting record?</h5>
                    ...
                    <div class="col-12" hidden>
                        <label>Amount</label>
                        <input type="text" name="amount" value="50" class="form-control" readonly>
                    </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="../../sql/fetch/request_record/pickup/dis_permit.php" method="POST">
                <div class="modal-body">
                  <h5>Disapproved this request</h5>
                    <input type="text" name="staff" value="<?php echo $_SESSION['fullname'] ?>" hidden>
                    ...
                    <div class="col-md-12 form-group mb-3" hidden>
                      <label>Date Paid</label>
                      <input style="padding:13px;" class="form-control" type="text" name="date_paid" value="<?php echo date("Y-m-d"); ?>" hidden>
                    </div>
                    <div class="col-12" hidden>
                        <label>Payment Status</label>
...
<div class="page-content p-0" id="content">
  ...
  <div class="separator"></div>
        ...
        <nav style="margin-left:15px;--bs-breadcrumb-divider: '|';" aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item" aria-current="page"><a href="business_permit_pickup.php" class="link-active">Pending Request</a></li>
                <!-- <li class="breadcrumb-item"><a href="business_permit_pickup/processed.php">Processed</a></li> -->
                <li class="breadcrumb-item"><a href="business_permit_pickup/get_record.php">Get Record</a></li>
                <li class="breadcrumb-item"><a href="business_permit_pickup/done.php">Done</a></li>
                <li class="breadcrumb-item"><a href="business_permit_pickup/disapproved.php">Disapproved</a></li>
            </ol>
        </nav>
            <div class="card-req">
                <div class="card-body">
                  <div class="row">
                    <div class="col-12">
                      <div class="row">
                        ...
                        <div class="col-3">
                        <a href="business_permit_pickup.php" class="btn btn-custom" style="width: 50px; float:right;padding:12px"><i class="fas fa-redo-alt" style="color:white;font-size:20px"></i></a>
...
<script>
  $(document).ready(function(){
    ...
    {
      $.ajax({
        url:"../../sql/fetch/request_record/pickup/fetch_request_business_permit_pick_up.php",
        method:"POST",
