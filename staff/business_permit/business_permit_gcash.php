...
<div class="modal fade" id="editmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="../../sql/fetch/request_record/gcash/request_gcash_permit_update.php" method="POST">
...
<div class="page-content p-0" id="content">
  ...
  <div class="separator"></div>
            ...
            <div class="card-body">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-sm-2">
                          <div class="tab">
                            <a href="business_permit_pickup.php" class="btn btn-custom tablinks">Pick Up</a>
                            <a href="business_permit_gcash.php" class="btn btn-custom  btn-active tablinks">Gcash</a>
                        </div>
                        </div>
                    </div>
                </div>
        ...
        <nav style="margin-left:15px;--bs-breadcrumb-divider: '|';" aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item" aria-current="page"><a href="business_permit_gcash.php" class="link-active">All Request</a></li>
                <!-- <li class="breadcrumb-item"><a href="business_permit_gcash/processed.php">Processed</a></li> -->
                <li class="breadcrumb-item"><a href="business_permit_gcash/get_record.php">Get Record</a></li>
                <li class="breadcrumb-item"><a href="business_permit_gcash/done.php">Done</a></li>
            </ol>
        </nav>
            <div class="card-req">
                <div class="card-body">
...
<script>
  $(document).ready(function(){
    ...
    {
      $.ajax({
        url:"../../sql/fetch/request_record/gcash/fetch_request_business_permit_gcash.php",
        method:"POST",
