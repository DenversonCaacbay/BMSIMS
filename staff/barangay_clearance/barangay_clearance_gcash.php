...
<div class="modal fade" id="editmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="../../sql/fetch/request_record/gcash/request_clearance_update.php" method="POST">
...
<div class="modal fade" id="dismodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="../../sql/fetch/request_record/gcash/dis_clearance.php" method="POST">
                <div class="modal-body">
...
<div class="page-content p-0" id="content">
  ...
  <div class="separator"></div>
            ...
            <div class="card-body">
                <div class="container">
                    <div class="row">
                        ...
                        <b>Barangay Clearance | GCASH</b>
                        </div>
                        <!-- <div class="col-sm-2">
                          <div class="tab">
                            <a href="barangay_clearance_pickup.php" class="btn btn-custom tablinks">Pick Up</a>
                            <a href="barangay_clearance_gcash.php" class="btn btn-custom  btn-active tablinks">Gcash</a>
                        </div>
                        </div> -->
                    </div>
                </div>
        ...
        <nav style="margin-left:15px;--bs-breadcrumb-divider: '|';" aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item" aria-current="page"><a href="barangay_clearance_gcash.php" class="link-active">Pending Request</a></li>
                <li class="breadcrumb-item"><a href="barangay_clearance_gcash/get_record.php">Get Record</a></li>
                <li class="breadcrumb-item"><a href="barangay_clearance_gcash/done.php">Done</a></li>
                <li class="breadcrumb-item"><a href="barangay_clearance_gcash/disapproved.php">Disapproved</a></li>
            </ol>
        </nav>
            <div class="card-req">
                <div class="card-body">
                  <div class="row">
                    <div class="col-12">
                      <div class="row">
                        ...
                        <div class="col-3">
                        <a href="barangay_clearance_gcash.php" class="btn btn-custom" style="width: 50px; float:right;padding:12px"><i class="fas fa-redo-alt" style="color:white;font-size:20px"></i></a>
...
<script>
  $(document).ready(function(){
    ...
    {
      $.ajax({
        url:"../../sql/fetch/request_record/gcash/fetch_request_barangay_clearance_gcash.php",
        method:"POST",
