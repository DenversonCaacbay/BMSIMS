        ...
        <div class="modal-content">
            ...
            <form action="../../sql/fetch/request_record/pickup/request_indigency_update.php" method="POST">
                <div class="modal-body">
                    ...
                    <input type="text" name="date_paid" value="N/A" class="form-control" placeholder="" hidden >
                    <input type="text" name="payment_status" id="payment_status" value="N/A" class="form-control" placeholder="" hidden>
...
<div class="page-content p-0" id="content">
  ...
  <div class="separator"></div>
        ...
        <nav style="margin-left:15px;--bs-breadcrumb-divider: '|';" aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item" aria-current="page"><a href="indigency_pickup.php" class="link-active">All Request</a></li>
