...
<div class="modal fade" id="editmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="../../../sql/fetch/request_record/processed/clearance/update_gcash.php" method="POST">
...
<div class="page-content p-0" id="content">
  ...
  <div class="separator"></div>
        ...
        <nav style="margin-left:15px;--bs-breadcrumb-divider: '|';" aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item" aria-current="page"><a href="../barangay_clearance_gcash.php">All Request</a></li>
                <li class="breadcrumb-item"><a href="processed.php" class="link-active">Processed</a></li>
                <li class="breadcrumb-item"><a href="get_record.php">Get Record</a></li>
                <li class="breadcrumb-item"><a href="get_record.php">Done</a></li>
            </ol>
        </nav>
            <div class="card-req">
                <div class="card-body">
                  <div class="row">
                    <div class="col-12">
                      <div class="row">
                        ...
                        <div class="col-3">
                        <a href="barangay_clearance_gcash_processed.php" class="btn btn-custom" style="width: 50px; float:right;padding:12px"><i class="fas fa-redo-alt" style="color:white;font-size:20px"></i></a>
                    ...
                    <!-- <a href="barangay_clearance_pickup_processed.php" class="btn btn-custom" style="width: 98%;margin:10px; float:right;padding:7px">Refresh</a> -->
                  </div>
...
<script>
  $(document).ready(function(){
    ...
    {
      $.ajax({
        url:"../../../sql/fetch/request_record/processed/clearance/gcash.php",
        method:"POST",
