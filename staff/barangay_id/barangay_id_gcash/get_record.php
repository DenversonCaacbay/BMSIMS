...
<head>
    ...
    <title>BMSIMS | Barangay Clearance</title>
...
<div class="modal fade" id="editmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="../../../sql/fetch/request_record/get_record/id/update_gcash.php" method="POST">
...
<script>
  $(document).ready(function(){
    ...
    {
      $.ajax({
        url:"../../../sql/fetch/request_record/get_record/id/gcash.php",
        method:"POST",
