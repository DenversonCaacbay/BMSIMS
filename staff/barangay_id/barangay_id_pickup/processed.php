...
<div class="modal fade" id="editmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="../../../sql/fetch/request_record/processed/id/update_pick_up.php" method="POST">
...
<div class="page-content p-0" id="content">
  ...
  <div class="separator"></div>
        ...
        <nav style="margin-left:15px;--bs-breadcrumb-divider: '|';" aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item" aria-current="page"><a href="../barangay_id_pickup.php">All Request</a></li>
...
<script>
  $(document).ready(function(){
    ...
    {
      $.ajax({
        url:"../../../sql/fetch/request_record/processed/id/pick_up.php",
        method:"POST",
