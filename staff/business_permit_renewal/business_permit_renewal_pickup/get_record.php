...
<div class="modal fade" id="editmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="../../../sql/fetch/request_record/get_record/permit_renewal/update_pickup.php" method="POST">
...
<div class="page-content p-0" id="content">
  ...
  <div class="separator"></div>
        ...
        <nav style="margin-left:15px;--bs-breadcrumb-divider: '|';" aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item" aria-current="page"><a href="../business_permit_renewal_pickup.php">All Request</a></li>
                  ...
                  <div class="row">
                    <div class="col-12">
                      <div class="row">
                        ...
                        <div class="col-3">
                        <a href="business_permit_renewal_pickup_get_record.php" class="btn btn-custom" style="width: 50px; float:right;padding:12px"><i class="fas fa-redo-alt" style="color:white;font-size:20px"></i></a>
...
<script>
  $(document).ready(function(){
    ...
    {
      $.ajax({
        url:"../../../sql/fetch/request_record/get_record/permit_renewal/pickup.php",
        method:"POST",
