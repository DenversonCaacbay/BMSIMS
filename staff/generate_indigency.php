  ...
  foreach($item_result as $sub_row)
  {
    ...
    $output .= '
        ...
        <h5 style="font-size:20px;">TO WHOM IT MAY CONCERN:</h5>
          <table>
            <tr>
              <td style="font-size:18px;text-indent: 50px;">This is to certify that <b>'.$sub_row["fullname"].'</b>, is a bonafide resident of Barangay Matain, Subic, Zambales. The said person is of good moral character and  an active member of the community. SHE/HE is one of those who belong to a low-income family.</td>
            </tr>
            <br>
            <tr>
              <td style="font-size:18px;text-indent: 50px;">This certification is being issued upon the request of the name above person for <b style="text-transform: uppercase">'.$sub_row["purpose"].' PURPOSES.</b></td>
            </tr>
            <br>
            <tr>
              <td style="font-size:18px;text-indent: 50px;">DONE AND ISSUED this on <b> '.date("F d, Y", strtotime($today)).' </b>  at Punong Barangay Office Barangay Matain, Subic, Zambales, Philippines.</td>
            </tr>
          </table>
