...
<body>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav ms-auto">
                        <li class="nav-item">
                            <a class="nav-link" style="cursor:pointer;" href="#hero" data-after="Home">
                                Home
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" style="cursor:pointer;" href="#projects" data-after="Projects">
                                Services
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" style="cursor:pointer;" href="#about" data-after="About">
                                About Us
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" style="cursor:pointer;" href="#contact" data-after="Contact">
                               Contact Us
                            </a>
                        </li>
                        <li class="nav-item">
  ...
  <!-- Hero Section  -->
  <section id="hero" style="top:0;">
    <div class="hero container1" style="top:0;">
      <div class="row" style="width:100%;">
        <div class="col-7 wel">
            <h1>Welcome to<span></span></h1>
            <h1>BMSIMS <span></span></h1>
            <h5>Barangay Matain Service and Infomation Management System<span></span></h5>
        </div>
       
        
        <!-- <a href="user/user_index.php" class="cta">Visit Our Website</a>
        ...
        <div class="row" style="width:99%;">
            ...
            <div class="col-7 col-right">
                <div class="">
                    ...
                    <h2>BMSIMS</h2>
                    <p>Barangay Matain Service and Information Management System is an online Service and Information Management System developed primarily for barangay matain and its residents on requesting and management of the records.</p>
                    <!-- <p>Our barangay operates from Mon to Fri, 8 am to 4 pm, excluding Public Holidays. Your request will be sent to our secretary, who will be in touch with you shortly.</p> -->
      ...
      <div class="row" style="width:100%">
            ...
            <div class="col-4 con">
                <div class="card card-2">
                    ...
                    <div class="card-body">
                        <p class="text-center">Barangay Matain, Subic, Zambales</p>
                    </div>
                </div>
            </div>
      </div>
  ...
  <section id="footer">
    <div class="footer container1">
      <h2>BMSIMS</h2>
      <p>Copyright © 2023 BMSIMS. All rights reserved</p>
    </div>
  </section>
  <!-- End Footer -->
